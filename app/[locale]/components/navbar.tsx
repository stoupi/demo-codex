...
export function Navbar() {
	...
	const [openMenu, setOpenMenu] = useState<
		null | 'info' | 'research' | 'team' | 'language'
	>(null);
			...
			<div className='container mx-auto flex h-20 items-center justify-between px-4'>
				<Link href={'/'} className='flex items-center gap-3'>
					...
					<div className='leading-tight w-max'>
						<div className='text-base font-medium tracking-[0.08em] text-[#0063AF]'>
							{t('service')}
						</div>
						<div className='my-0.5 h-[2px] w-full bg-[#0063AF]' />
						<div className='text-base font-bold uppercase tracking-wide text-[#0063AF]'>
							{t('hospital')}
						</div>
					</div>
				</Link>
				...
				<div className='hidden md:flex items-center gap-10 text-lg'>
					<DropdownMenu
						...
						onOpenChange={(o) =>
							setOpenMenu(
								o ? 'info' : openMenu === 'info' ? null : openMenu
							)
						}>
						<DropdownMenuTrigger
						...
						<DropdownMenuContent
							...
							<DropdownMenuItem
								...
								asChild>
									<Link href={'/emergencies'} className='w-full'>
									{t('emergencies')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
					...
					<Link
						href={'/services'}
						className='text-[#0063AF] hover:text-[#0063AF] font-medium'>
						{t('care')}
					</Link>
					<DropdownMenu
						open={openMenu === 'research'}
						onOpenChange={(o) =>
							setOpenMenu(
								o
									? 'research'
						...
						<DropdownMenuContent
							...
							<DropdownMenuItem
								className='text-base md:text-lg py-2 text-[#0063AF] hover:bg-[#0F2C6B] hover:text-white focus:bg-[#0F2C6B] focus:text-white data-[highlighted]:bg-[#0F2C6B] data-[highlighted]:text-white transition-colors'
								asChild>
									<Link href={'/research/miracl-ai'} className='w-full'>
									{t('miracl')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								className='text-base md:text-lg py-2 text-[#0063AF] hover:bg-[#0F2C6B] hover:text-white focus:bg-[#0F2C6B] focus:text-white data-[highlighted]:bg-[#0F2C6B] data-[highlighted]:text-white transition-colors'
								asChild>
									<Link href={'/research/addicto-usic'} className='w-full'>
									{t('addicto')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								className='text-base md:text-lg py-2 text-[#0063AF] hover:bg-[#0F2C6B] hover:text-white focus:bg-[#0F2C6B] focus:text-white data-[highlighted]:bg-[#0F2C6B] data-[highlighted]:text-white transition-colors'
								asChild>
									<Link href={'/research/andaman'} className='w-full'>
									{t('andaman')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								className='text-base md:text-lg py-2 text-[#0063AF] hover:bg-[#0F2C6B] hover:text-white focus:bg-[#0F2C6B] focus:text-white data-[highlighted]:bg-[#0F2C6B] data-[highlighted]:text-white transition-colors'
								asChild>
									<Link href={'/research/eacvi-mmvd'} className='w-full'>
									{t('eacvi')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								className='text-base md:text-lg py-2 text-[#0063AF] hover:bg-[#0F2C6B] hover:text-white focus:bg-[#0F2C6B] focus:text-white data-[highlighted]:bg-[#0F2C6B] data-[highlighted]:text-white transition-colors'
								asChild>
									<Link href={'/research/publications'} className='w-full'>
									{t('publications')}
								</Link>
							</DropdownMenuItem>
						</DropdownMenuContent>
					...
					<DropdownMenu
						...
						onOpenChange={(o) =>
							setOpenMenu(
								o ? 'team' : openMenu === 'team' ? null : openMenu
							)
						}>
						<DropdownMenuTrigger
							className='text-[#0063AF] hover:text-[#0063AF] outline-none font-medium'
					...
					<Link
						...
						<DropdownMenuItem
							...
							asChild>
								<Link
									href={{ pathname: '/team', hash: 'paramedical' }}
									className='w-full'>
									{t('teamParamedical')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								...
								asChild>
								<Link
									href={{ pathname: '/team', hash: 'administrative' }}
									className='w-full'>
									{t('teamAdministrative')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								className='text-base md:text-lg py-2 text-[#0063AF] hover:bg-[#0F2C6B] hover:text-white focus:bg-[#0F2C6B] focus:text-white data-[highlighted]:bg-[#0F2C6B] data-[highlighted]:text-white transition-colors'
								asChild>
								<Link
									href={{ pathname: '/team', hash: 'research' }}
									className='w-full'>
									{t('teamResearch')}
								</Link>
							</DropdownMenuItem>
							<DropdownMenuItem
								...
								asChild>
								<Link
									href={{ pathname: '/team', hash: 'gallery' }}
									className='w-full'>
									{t('teamGallery')}
								</Link>
							</DropdownMenuItem>
